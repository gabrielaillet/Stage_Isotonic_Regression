...
from PQ_Tree_To_Graph_Transformation import from_pi_qew_tree_to_basic_graph_with_position_and_weight,taking_only_coordinates
...
def make_isotonic_regression_for_l2(distance, pi_qwe_tree, plot_result = False):
    ...
    result_of_isotonic_regression = ir.fit_transform(first_order, taking_only_coordinates(position_vector), sample_weight=taking_only_coordinates(weight_vector))
...
# Plot result
    ...
    return study_isotonic_regression_l2(distance,graph,list_tuple_with_nb_of_vertices_and_result_of_isotonic_regression)
